...
public class ByteArray {
     ...
     * get the correct result. If we were to strip off the leading zero then when you convert back to BigInteger you will get
    ...
    */
    ...
    public boolean equals(Object other) {
        ...
        return Arrays.equals(array, rhs.array);
    }
