...
public class HkdfTest {
     ...
     * 96596776afdb6377ac434c1c293ccb04 (32 octets)
     * OKM  = 0x8da4e775a563c18f715f802a063c5a31
     * b8a11f5c5ee1879ec3454e5f3c738d2d (32 octets)
     * </pre>
     *
     */
    @Test
    public void testCase3a() throws DecoderException, NoSuchAlgorithmException, InvalidKeyException {
        byte[] ikm = Hex.decodeHex("0b0b0b0b0b0b0b0b0b0b0b0b0b0b0b0b0b0b0b0b0b0b".toCharArray());
        assertEquals(22, ikm.length);
        byte[] salt = new byte[0];
        byte[] info = new byte[0];
        ...
        assertEquals("8da4e775a563c18f715f802a063c5a31b8a11f5c5ee1879ec3454e5f3c738d2d", Hex.encodeHexString(okm));
    }
     ...
     * 96596776afdb6377ac434c1c293ccb04 (32 octets)
     * OKM  = 0x8da4e775a563c18f715f802a063c5a31
     * b8a11f5c5ee1879ec3454e5f3c738d2d9d201395f
     * aa4b61a96c8b2fb61057244b36c6ddd287f634795
     * e7d80d5fe26bfc (64 octets)
     * </pre>
     *
     */
    @Test
    public void testCase3b() throws DecoderException, NoSuchAlgorithmException, InvalidKeyException {
        byte[] ikm = Hex.decodeHex("0b0b0b0b0b0b0b0b0b0b0b0b0b0b0b0b0b0b0b0b0b0b".toCharArray());
        assertEquals(22, ikm.length);
        byte[] salt = new byte[0];
        byte[] info = new byte[0];
        ...
        byte[] okm = hkdf.deriveKey(salt, ikm, length, info);
        log.debug("Generated key: {}", Hex.encodeHexString(okm));
        assertEquals("8da4e775a563c18f715f802a063c5a31b8a11f5c5ee1879ec3454e5f3c738d2d9d201395faa4b61a96c8b2fb61057244b36c6ddd287f634795e7d80d5fe26bfc", Hex.encodeHexString(okm));
    }
     ...
     *
     * PRK  = 0x2adccada18779e7c2077ad2eb19d3f3e731385dd (20 octets)
     * OKM  = 0x2c91117204d745f3500d636a62f64f0ab3bae548 (20 octets)
     * </pre>
     *
     */
    @Test
    public void testCase7a() throws DecoderException, NoSuchAlgorithmException, InvalidKeyException {
        ...
        HKDF hkdf = new HKDF("HmacSHA1");
        byte[] okm = hkdf.deriveKey(ikm, length, info);
        assertEquals("2c91117204d745f3500d636a62f64f0ab3bae548", Hex.encodeHexString(okm));
    }
