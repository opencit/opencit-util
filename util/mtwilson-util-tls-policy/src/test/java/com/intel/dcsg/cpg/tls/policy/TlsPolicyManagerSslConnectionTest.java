...
public class TlsPolicyManagerSslConnectionTest {
    ...
    public void testSslConnectionKnownCertificatePolicy() throws Exception {
        TlsPolicy tlsPolicyTrustKnownCertificate = new CertificateTlsPolicy(new ArrayCertificateRepository(new X509Certificate[] { TestTlsPolicyWithServerCaSigned.tlsCert }));
        String serverHostname = "127.0.0.1";
        int serverPort = TestTlsPolicyWithServerCaSigned.serverPort;
...
//    @Test(expected=SSLPeerUnverifiedException.class)
    ...
    public void testSslConnectionKnownCertificatePolicyWithHostnameVerification() throws Exception {
        TlsPolicy tlsPolicy = new CertificateTlsPolicy(new ArrayCertificateRepository(new X509Certificate[] { TestTlsPolicyWithServerCaSigned.tlsCert }));
