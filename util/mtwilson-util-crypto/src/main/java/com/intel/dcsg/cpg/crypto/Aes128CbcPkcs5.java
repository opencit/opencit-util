 ...
 * @author jbuhacoff
 */
public class Aes128CbcPkcs5 {
    private SecretKey secretKey;
    private static int KEY_LENGTH = 128;
    private static int BLOCK_SIZE = 16; // KEY_LENGTH / 8
    private Cipher cipher;
    
    public Aes128CbcPkcs5(byte[] secretKeyAes128) throws CryptographyException {
        try {
    ...
    public Aes128CbcPkcs5(SecretKey secretKeyAes128) throws CryptographyException {
        try {
            cipher = Cipher.getInstance("AES/CBC/PKCS5Padding");
