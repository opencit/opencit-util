...
public class Digest {
   ...
   public static DigestBuilder sha224() {
    ...
    public boolean isValidBase64(String digestBase64) {
        ...
        /**
         * 
         * @return the length in bytes of a digest of the specified algorithm; for example MD5 length is 16, SHA1 length is 20
         */
        public int length() {
            try {
        ...
        /**
         * 
         * @param messageHex hex representation of the bytes to digest; the input is first converted to bytes ("00" is byte 0x00) then digested
         * @return 
         */
        ...
        /**
         * 
         * @param messageBase64 base64 representation of the bytes to digest; the input is first converted to bytes then digested
         * @return 
         */
