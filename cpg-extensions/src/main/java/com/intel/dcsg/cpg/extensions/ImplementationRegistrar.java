 ...
 * 
 * A plugin class can be any class that has a no-arg constructor 
 * (or a one-arg constructor for context-sensitive plugins) and is not 
 * itself an interface or an abstract class, but implements one or more interfaces.
 *
 * @author jbuhacoff
 */
