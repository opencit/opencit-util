 ...
 * @since 0.5.2
 * @author jbuhacoff
 * @deprecated use com.intel.mtwilson.fs in mtwilson-configuration instead
 */
public final class ConfigurationUtil {
     ...
     * @since 0.5.4
     * @deprecated currently used only from mtwilson-client-java6 AbstractCommand; remove at earliest opportunity
     */
    public static Configuration getConfiguration() { return rc3; }
    
    /**
     * @return the file representing mtwilson.properties
     * @deprecated currently not used by any code
     */
    ...
    private static String getDefaultMtWilsonHome() {
        ...
        if( flavorSpecificDefault == null ) { throw new IllegalStateException("Unsupported operating system: "+System.getProperty("os.name", "undefined")); }
    ...
    public static Configuration fromResource(String resourceName) throws IOException {
        try(InputStream in = ConfigurationUtil.class.getResourceAsStream(resourceName)) {
