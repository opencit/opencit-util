...
public class EncryptedTokenAuthenticationFilter extends AuthenticatingFilter {
    ...
    protected AuthenticationToken createToken(ServletRequest sr, ServletResponse sr1) throws Exception {
        ...
        int duration = Integer.valueOf(configuration.get("mtwilson.portal.sessionTimeOut", "1800")); //My.configuration().getConfiguration().getInt("mtwilson.portal.sessionTimeOut", 1800); // use same duration as the session timeout in Mt Wilson 1.2
